...
# خريطة البنود — **تُقرأ ولا تُعرَّف** (`instrument_pin`): منقولة من الجدول
# المختوم `41 §5.3`، **ويقابلها `build_site.validate_maps` بفكٍّ مستقل للجدول
# عند كل بناء**. وإظهارها هنا هو ما كانت `GAP-ITEM-K3-01` تنتظره: مراجعة صدق
# المضمون تحتاج أن تُرى البنود المغذّية لكل مهارة (`119 §1/③`) — وكانت الخريطة
# قائمةً في طبقة البناء وحدها، فصارت الدائرة الثالثة **مستوية مع أختيها**
# ($K_2$ و$K_4$) بعد أن كانت وحدها بلا خريطة في محرّكها (`DEC-275`).
#
# ولا يُضاف معها حسابُ الخام→SP: هو قائم في `bridge.spK3`، وتكراره هنا
# **يُنشئ سلطةً ثانية** على معادلةٍ واحدة (`م-2`). فالمُظهَر خريطةٌ لا معادلة.
ITEM_MAP = {
    "EP": [(3, 'b'), (12, 'a'), (20, 'b'), (23, 'a'), (33, 'b'), (38, 'a'), (51, 'a'), (63, 'a'), (74, 'a'), (83, 'a'), (88, 'a')],
    "IR": [(2, 'b'), (11, 'a'), (20, 'a'), (35, 'a'), (48, 'a'), (60, 'a'), (71, 'a'), (80, 'a'), (86, 'a'), (90, 'a'), (93, 'a')],
    "BI": [(2, 'a'), (18, 'a'), (33, 'a'), (47, 'a'), (59, 'a'), (69, 'a'), (78, 'a'), (85, 'a'), (89, 'a'), (92, 'a'), (94, 'a')],
    "CF": [(3, 'a'), (11, 'b'), (18, 'b'), (21, 'a'), (36, 'a'), (50, 'a'), (62, 'a'), (72, 'a'), (81, 'a'), (87, 'a'), (91, 'a')],
    "ST": [(5, 'a'), (12, 'b'), (21, 'b'), (24, 'a'), (35, 'b'), (39, 'a'), (47, 'b'), (53, 'a'), (65, 'a'), (75, 'a'), (84, 'a')],
}
