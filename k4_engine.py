...
# --------------------------------------------------------------------------- #
# 0) خريطة الأوعية — **منقولة من الجدول المختوم** (`41 §5.4` ≡ `14-CORE-K4 §4`)
# --------------------------------------------------------------------------- #
# `instrument_pin`: هذه الخريطة **تُقرأ ولا تُعرَّف**؛ ومطابقتها للجدول المختوم
# مفحوصة آلياً في `build_site.validate_maps` (يفكّ الجدول ويقارن).
# قيد التكافؤ المختوم (`128 §1`): صفّ `K4-SP` في الجدول **يُقرأ `PER`**.
# والعزل مبرهَن: 77 خانة · صفر تقاطع مع K2 (56) وK3 (55) — والثلاث تقسّم
# خانات الأداة الـ188 تقسيماً تاماً بلا زيادة ولا نقص.
ITEM_MAP = {
